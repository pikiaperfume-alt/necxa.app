...
package com.antonkarpenko.ffmpegkit.flutter;
...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler, PluginRegistry.ActivityResultListener {
    ...
    protected void registerGlobalCallbacks() {
        com.arthenica.ffmpegkit.FFmpegKitConfig.enableFFmpegSessionCompleteCallback(this::emitSession);
        com.arthenica.ffmpegkit.FFmpegKitConfig.enableFFprobeSessionCompleteCallback(this::emitSession);
        com.arthenica.ffmpegkit.FFmpegKitConfig.enableMediaInformationSessionCompleteCallback(this::emitSession);
    ...
    public void onAttachedToEngine(@NonNull final FlutterPluginBinding flutterPluginBinding) {
        ...
        init(flutterPluginBinding.getBinaryMessenger(), flutterPluginBinding.getApplicationContext(), null, null);
    }
